...
public partial class Client_TransactionPassword : System.Web.UI.Page
{
    ...
    protected void UpdateUser_Click_Password(object sender, EventArgs e)
    {
    	...
    	try
        {
            string str = "update ClientProfile set TPassword='" +Password2.Text+ "' where UserName='" +Session["name"].ToString()+ "' ";
            con.Open();
