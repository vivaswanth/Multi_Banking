<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="MasterAdmin.Master" CodeFile="AdminNotifications.aspx.cs" Inherits="Admin_AdminNotifications" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

	<div class="container" style="margin-top: 5%">
		<h2>Notifications</h2>
		<p>Following are the questions asked to you by customers.</p>
		<hr>
